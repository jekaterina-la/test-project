...
if (isset($_POST["submit"])){
    ...
    DB::run("INSERT INTO products (SKU, name, price, parameter) VALUES ('$sku', '$name', '$price', '$size') ");
...
<body class="p-4">
        ...
        <div class="d-flex pl-2">
                <form action="/TEST-TASK/add.php" method="post">
                    ...
                    <div class="form-group mb-2 size-to-hide">
                            <label>
                                    Size
                                    <input class="form-control mt-2" name="size" aria-describedby="shelper">
                    ...
                    <div class="form-group mb-2 dimension-to-hide">
                            <label>
                                    Height, Width, Length
                                    <input class="form-control mt-2" name="dimension" aria-describedby="dhelper">
                    ...
                    <div class="form-group mb-2 weight-to-hide">
                            <label>
                                    Weight
                                    <input class="form-control mt-2" name="weight" aria-describedby="whelper">
